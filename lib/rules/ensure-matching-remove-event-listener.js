  ...
  create(context) {
    ...
    return {
      ExpressionStatement(node) {
        ...
        const internalExpressions = expression.arguments[0].body.body;
        internalExpressions.forEach((element) => {
          ...
          if (calleeName === "useEffect") {
            if (
              ...
              if (elementType === "ReturnStatement") {
                const returnBlockBody = element.argument.body.body;
                returnBlockBody.forEach((returnElement) => {
                  const returnElementCallee = returnElement.expression.callee;
